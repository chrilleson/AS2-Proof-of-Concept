    ...
    public class AS2MIMEUtilities
    {
        ...
        public static byte[] CreateMessage(string sContentType, string sEncoding, string sDisposition, out int iHeaderLength, params byte[][] abMessageParts)
        {
            ...
            else
            {
                ...
                byte[] bFinalFooter = Encoding.ASCII.GetBytes(Environment.NewLine + "--" + sBoundary + "--" + Environment.NewLine);
        ...
        /// <returns></returns>
        public static byte[] Sign(byte[] arMessage, string signerCert, SecureString signerPassword, out string sContentType)
        {
            ...
            byte[] bFinalFooter = Encoding.ASCII.GetBytes("--" + sBoundary + "--" + Environment.NewLine);

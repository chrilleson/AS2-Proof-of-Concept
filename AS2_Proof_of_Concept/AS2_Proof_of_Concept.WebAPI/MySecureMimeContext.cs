...
namespace AS2_Proof_of_Concept.WebAPI
{
    ...
    {
        public MySecureMimeContext() : base(OpenDatabase(@"C:\Users\chris\source\repos\AS2 Proof of Concept\AS2_Proof_of_Concept\AS2_Proof_of_Concept.WebAPI\certs\certificate.db"))
        {
        }
